...
import cn.stormbirds.payservice.paypal.bean.PayPalTransactionType;
import cn.stormbirds.payservice.paypal.bean.order.*;
...
/**
 *
 * @ Description 贝宝支付配置容器
 * @ Author StormBirds
 * @ Email xbaojun@gmail.com
 * @ Date 2019/6/17 20:28
 *
 */
public class PayPalPayService extends BasePayService<PayPalConfigStorage>{
    ...
    public Map<String, Object> refundquery(RefundOrder refundOrder) {
        return getHttpRequestTemplate().getForObject(getReqUrl(PayPalTransactionType.REFUND_QUERY), authHeader(), JSONObject.class);
    }
