package cn.stormbirds.payservice.common.http;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONException;
import cn.stormbirds.payservice.common.bean.MethodType;
...
import static cn.stormbirds.payservice.common.http.UriVariables.getMapToParameters;
...
public class ClientHttpRequest<T> extends HttpEntityEnclosingRequestBase implements  org.apache.http.client.ResponseHandler<T>{
     ...
     *
     * @param method 请求方式
     * {@link cn.stormbirds.payservice.common.bean.MethodType} 请求方式
     */
