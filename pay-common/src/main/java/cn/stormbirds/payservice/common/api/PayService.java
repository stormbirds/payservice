...
public interface PayService<PC extends PayConfigStorage> {
     ...
     * @param handler 消息处理器
     * 配合{@link  cn.stormbirds.payservice.common.api.PayService#payBack(Map, InputStream)}进行使用
     *
     *   默认使用{@link  cn.stormbirds.payservice.common.api.DefaultPayMessageHandler }进行实现
     *
     */
